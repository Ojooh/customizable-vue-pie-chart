<template>
    <div :class="['pie-chart-container', sizeClass, containerClass]">
    <!-- Legend Text -->
...
export default {
  ...
  props: {
    ...
    segmentColors: { type: Array, default: () => ["#ff6384", "#36a2eb", "#cc65fe", "#ffce56"] },

    showText: { type: Boolean, default: true },

    textSize: { type: String, default: "4" },
  ...
  computed: {
    ...
    sizeClass() {
      return this.large ? "pie-chart-large" : "pie-chart-small";
    },
...
<style scoped src="../styles/pie_chart.css"></style>